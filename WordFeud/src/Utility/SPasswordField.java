...
public class SPasswordField extends JPasswordField {
	...
	/**
	 * SPasswordField constructor parameters: String text<br>
	 * This constructor creates a passwordField that is the size of the placeholder
	 */
	...
	/**
	 * SPasswordField constructor parameters: String text, int width, int height<br>
	 * This constructor creates a passwordField that is the size of width and height parameters
	 */
	...
	/**
	 * Overridden paintComponent(Graphics g) method from JComponent used to draw better graphics for passwordfield<br>
	 * This passwordField has different shapes including: rounded, square, square-rounded<br>
