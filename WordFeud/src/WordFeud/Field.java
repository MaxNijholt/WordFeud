...
public class Field {
	...
	/**
	 * lays a game stone on the playing field
	 * if there is a Game stone already nothing happens
	 * @param gamestone
	 * @param location
	 */
	...
	/**
	 * Removes a game stone from the playing field
	 * @param location
	 */
