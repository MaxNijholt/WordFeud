...
public class GameStone extends SLabel {
	...
	public GameStone(int value, char letter){
		super(String.valueOf(letter), SLabel.CENTER, new Font("Arial", Font.BOLD, 40), 45, 45);
		this.value 	= value;
		this.letter = letter;
		this.large 	= new Font("Arial", Font.BOLD, 30);
		this.small	= new Font("Arial", Font.PLAIN, 10);
	}
	...
	public void paintComponent(Graphics g) {
		...
		g2d.setColor(Color.BLACK);
		g2d.setFont(small);
		g.drawString(temp, getWidth() - fmSmall.stringWidth(String.valueOf(value)) - 3, (fmSmall.getHeight() / 2) + 5);
	}
